...
import com.civet.myadmin.modules.cms.dao.CategoryDao;
...
//				list.addAll(0, dao.find(dc));
	...
	public List<Category> findByParentId(Integer parentId, Integer siteId){
...
//			}
			for(String id : idss){
				Category e = dao.get(com.civet.myadmin.common.utils.StringUtils.toInteger(id));
				if(null != e){
