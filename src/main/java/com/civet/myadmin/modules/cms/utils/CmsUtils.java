 ...
 */
package com.civet.myadmin.modules.cms.utils;
...
public class CmsUtils {
	 ...
	 * @param siteId 站点编号
	 */
	public static List<Category> getMainNavList(Integer siteId){
		@SuppressWarnings("unchecked")
	 ...
	 */
	public static List<Category> getCategoryList(Integer siteId, Integer parentId, int number, String param){
	 ...
	 */
	public static List<Article> getArticleList(Integer siteId, Integer categoryId, int number, String param){
	 ...
	 * @return
	 */
	public static Link getLink(Integer linkId){
	 ...
	 * @return
	 */
	public static List<Link> getLinkList(Integer siteId, Integer categoryId, int number, String param){
