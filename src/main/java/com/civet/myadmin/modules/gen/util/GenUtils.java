 ...
 */
package com.civet.myadmin.modules.gen.util;
...
import com.civet.myadmin.common.utils.FreeMarkers;
...
import com.civet.myadmin.common.mapper.JaxbMapper;
import com.civet.myadmin.common.utils.FileUtils;
import com.civet.myadmin.common.utils.StringUtils;
import com.civet.myadmin.modules.gen.entity.GenCategory;
import com.civet.myadmin.modules.gen.entity.GenConfig;
		...
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "CHAR")
				...
				column.setShowType("dateselect");
                    ...
                    || StringUtils.endsWithIgnoreCase(column.getJdbcType(), "INT")){
				// 如果是浮点型
