...
import com.civet.myadmin.common.security.Digests;
import com.civet.myadmin.common.security.shiro.session.SessionDAO;
import com.civet.myadmin.common.service.ServiceException;
import com.civet.myadmin.common.utils.CacheUtils;
import com.civet.myadmin.common.utils.Encodes;
import com.civet.myadmin.common.utils.StringUtils;
import com.civet.myadmin.common.web.Servlets;
import com.civet.myadmin.modules.sys.dao.MenuDao;
import com.civet.myadmin.modules.sys.dao.RoleDao;
import com.civet.myadmin.modules.sys.dao.UserDao;
...
import com.civet.myadmin.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+ Global.getConfig("productName")+"  - Powered By XXX\r\n");
		sb.append("\r\n======================================================================\r\n");
