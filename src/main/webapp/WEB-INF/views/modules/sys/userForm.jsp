...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">归属分组:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="100" class="mobile required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="address" htmlEscape="false" rows="4" maxlength="200"/>
			</div>
		</div>
		<div class="control-group">
